...
var APP_SCHEMAS = {
  Taxonomia: {
    ...
    fields: [
      ...
      { name: "flujos_vinculados", type: "relation", relationType: "hijo", targetEntity: "Flujo", graphEntity: "Sys_Graph_Edges", valueField: "id_flujo", labelField: "nombre", uiComponent: "embedded_dataview", label: "Flujos de la Taxonomía", isTemporalGraph: true, graphEdgeType: "TAXONOMIA_FLUJO", topologyCardinality: "M:N", width: 12, section: "Flujos" },
  ...
  Portafolio: {
    ...
    fields: [
      ...
      { name: "flujos_vinculados", type: "relation", relationType: "hijo", targetEntity: "Flujo", graphEntity: "Sys_Graph_Edges", valueField: "id_flujo", labelField: "nombre", uiComponent: "searchable_multi", label: "Flujos", isTemporalGraph: true, graphEdgeType: "PORTAFOLIO_FLUJO", topologyCardinality: "N:M", width: 12 }
    ]
  },
  Dominio: {
    ...
    fields: [
      ...
      { name: "flujos_vinculados", type: "relation", relationType: "padre", targetEntity: "Flujo", graphEntity: "Sys_Graph_Edges", valueField: "id_flujo", labelField: "nombre", uiComponent: "searchable_multi", label: "Flujos", isTemporalGraph: true, graphEdgeType: "FLUJO_DOMINIO", topologyCardinality: "N:M", required: false, readonly: true, placeholder: "Para vincular vaya al flujo de Taxonomía.", hideIfEmptyAndReadonly: false },
  ...
  Grupo_Productos: {
    metadata: { showInMenu: true, order: 4, iconName: 'layers-outline', color: 'dark', label: 'Grupos de Producto', titleField: 'nombre', idField: 'id_grupo_producto', fkField: { key: 'id_flujo', label: 'Flujo' } },
    topological_metadata: {
      ownerFields: ["group_manager_id"],
      parentEntity: "Flujo",
      parentField: "id_flujo"
    },
    mutationInterceptors: ['AutoProvisionEntityRoles'],
    ...
    fields: [
      ...
      { width: 12, name: "id_flujo", type: "relation", relationType: "padre", targetEntity: "Flujo", graphEntity: "Sys_Graph_Edges", valueField: "id_flujo", labelField: "nombre", uiComponent: "select_single", label: "Value Stream", isTemporalGraph: true, graphEdgeType: "FLUJO_GRUPO_PRODUCTO", topologyCardinality: "1:N", required: true },
  ...
  Equipo: {
    ...
    fields: [
      ...
      { name: "product_owner_id", type: "relation", relationType: "hijo", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", label: "Dueño de Producto", isTemporalGraph: true, graphEdgeType: "EQUIPO_PO", uiComponent: "searchable_single", valueField: "id_persona", labelField: "_nombre_completo", readonly: true, readonlyInContext: false, required: false, width: 6, hideIfEmptyAndReadonly: false },
      { name: "technical_lead_id", type: "relation", relationType: "hijo", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", label: "Líder Técnico", isTemporalGraph: true, graphEdgeType: "EQUIPO_TL", uiComponent: "searchable_single", valueField: "id_persona", labelField: "_nombre_completo", readonly: true, readonlyInContext: false, required: false, width: 6, hideIfEmptyAndReadonly: false },
  ...
  Flujo: {
    ...
    metadata: { prefix: 'FLUJ', showInMenu: true, order: 8, iconName: 'swap-horizontal-outline', color: 'tertiary', label: 'Flujos', titleField: 'nombre', idField: 'id_flujo', fkField: null, maxListAttrs: 8 },
    topological_metadata: {
      ownerFields: ["dueno_flujo_id", "head_of_technology_id"],
    ...
    topologyRules: TOPOLOGY_PRESETS.JERARQUICA_ESTRICTA_GRAPH_STD,
    fields: [
      { name: "id_flujo", type: "hidden", primaryKey: true },
      ...FIELD_TEMPLATES.SYSTEM_FIELDS(),
      { name: "estado", type: "hidden", defaultValue: "Borrador" },
      ...FIELD_TEMPLATES.AUDIT_FIELDS(),
      ...FIELD_TEMPLATES.VERSION_FIELD(),
      ...FIELD_TEMPLATES.NAME_FIELD("Nombre", 12),
      { name: "descripcion", type: "text", label: "Descripción / Propósito", required: false, width: 12, section: "Configuración General" },
      { name: "dueno_flujo_id", type: "relation", relationType: "padre", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", label: "Dueño del Flujo", isTemporalGraph: true, graphEdgeType: "FLUJO_DUENO", uiComponent: "searchable_single", valueField: "id_persona", labelField: "_nombre_completo", width: 12, section: "Liderazgo" },
      { name: "head_of_technology_id", type: "relation", relationType: "padre", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", label: "Head of Technology", isTemporalGraph: true, graphEdgeType: "FLUJO_HEAD_OF_TECHNOLOGY", uiComponent: "searchable_single", valueField: "id_persona", labelField: "_nombre_completo", width: 12, section: "Liderazgo" },
      { name: "head_of_product_id", type: "relation", relationType: "padre", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", label: "Head of Product", isTemporalGraph: true, graphEdgeType: "FLUJO_HEAD_OF_PRODUCT", uiComponent: "searchable_single", valueField: "id_persona", labelField: "_nombre_completo", width: 12, section: "Liderazgo" },
      { name: "agile_coach_id", type: "relation", relationType: "padre", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", label: "Agile Coach", isTemporalGraph: true, graphEdgeType: "FLUJO_AGILE_COACH", uiComponent: "searchable_single", valueField: "id_persona", labelField: "_nombre_completo", width: 12, section: "Liderazgo" },
      { width: 12, name: "portafolios_padre", type: "relation", relationType: "padre", targetEntity: "Portafolio", graphEntity: "Sys_Graph_Edges", valueField: "id_portafolio", labelField: "nombre", uiComponent: "searchable_multi", label: "Portafolios", isTemporalGraph: true, graphEdgeType: "PORTAFOLIO_FLUJO", topologyCardinality: "N:M", required: false, section: "Configuración General" },
      { width: 12, name: "dominios_vinculados", type: "relation", relationType: "hijo", targetEntity: "Dominio", graphEntity: "Sys_Graph_Edges", valueField: "id_dominio", labelField: "nombre", uiComponent: "treemap_selector", label: "Dominios", isTemporalGraph: true, graphEdgeType: "FLUJO_DOMINIO", topologyCardinality: "N:M", section: "Contexto Organizacional" },
      { width: 12, name: "grupos_productos_vinculados", type: "relation", relationType: "hijo", targetEntity: "Grupo_Productos", graphEntity: "Sys_Graph_Edges", valueField: "id_grupo_producto", labelField: "nombre", uiComponent: "searchable_multi", label: "Grupos de Productos", isTemporalGraph: true, graphEdgeType: "FLUJO_GRUPO_PRODUCTO", topologyCardinality: "1:N", section: "Contexto Organizacional" },
      { width: 12, name: "flujo_pasos", type: "relation", relationType: "hijo", targetEntity: "Flujo", graphEntity: "Sys_Graph_Edges", valueField: "id_flujo", labelField: "nombre", uiComponent: "searchable_multi", label: "Pasos del Flujo", isTemporalGraph: true, graphEdgeType: "FLUJO_PASO", topologyCardinality: "N:M", section: "Pasos del Flujo", actionLabel: "Vincular Paso" },
      { name: "div_canvas", type: "divider", label: "CANVAS", width: 12, icon: "analytics-outline", section: "Pasos del Flujo" },
      { name: "canvas_flujo", type: "uiComponent", label: "Modelador de Flujo", width: 12, uiComponent: "canvas_launcher", required: false, section: "Pasos del Flujo" }
    ]
  },
