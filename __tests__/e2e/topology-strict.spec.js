...
async function clickTopButtonByText(frame, text) {
  ...
  test('Race Condition Subgrid Prevention: Múltiples Clics concurrentes deben bloquear dobles guardados topologicos', async () => {
    ...
    // Inyectar 5 Clics simultáneos extremadamente rápidos usando JS nativo para burlar bloqueos mecánicos
    ...
    // El "Guardar" debe completarse y regresar sin tirar Topology Error por autoinserciones duplicadas idénticas (Sibling Collision Rule 11 en Engine Graph)
