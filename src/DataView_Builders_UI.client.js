/* ============================================================
    ...
    window.UI_DataViewBuilders = {
        buildColPopoverContentHTML: function(state) {
        ...
        ensureColPopover: function(state) {
            ...
            pop.appendChild(this.buildColPopoverContentHTML(state));
        ...
        buildToolbarHTML: function(state) {
            ...
            btnTable.className = 'dv-btn-icon ' + (state.view === 'table' ? 'active' : '');
            ...
            btnGrid.className = 'dv-btn-icon ' + (state.view === 'grid' ? 'active' : '');
            ...
            if (state.entityName === 'Dominio') {
                const btnMap = document.createElement('button');
                btnMap.className = 'dv-btn-icon ' + (state.view === 'map' ? 'active' : '');
        ...
        buildHeader: function(state) {
            const meta = (window.ENTITY_META && window.ENTITY_META[state.entityName]) || { iconName: 'document-text-outline', color: 'medium', label: window.formatEntityName(state.entityName) };
            const total = state.data.length;
            const displayLabel = window.formatEntityName(meta.label || state.entityName);
            ...
            btnAdd.addEventListener('click', () => window.renderForm(state.entityName));
