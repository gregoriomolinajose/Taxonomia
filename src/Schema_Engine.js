...
var APP_SCHEMAS = {
  Taxonomia: {
    ...
    fields: [
      ...
      { name: "equipos_vinculados", type: "relation", relationType: "hijo", targetEntity: "Equipo", graphEntity: "Sys_Graph_Edges", valueField: "id_equipo", labelField: "nombre", uiComponent: "embedded_dataview", label: "Equipos de la Taxonomía", isTemporalGraph: true, graphEdgeType: "TAXONOMIA_EQUIPO", topologyCardinality: "M:N", width: 12, section: "Importar Equipos" },
  ...
  Value_Stream: {
    ...
    fields: [
      ...
      { width: 12, name: "dominios_vinculados", type: "relation", relationType: "hijo", targetEntity: "Dominio", graphEntity: "Sys_Graph_Edges", valueField: "id_dominio", labelField: "nombre", uiComponent: "searchable_multi", label: "Dominios", isTemporalGraph: true, graphEdgeType: "VALUE_STREAM_DOMINIO", topologyCardinality: "N:M" },
