...
var APP_SCHEMAS = {
  Taxonomia: {
    ...
    fields: [
      ...
      { name: "id_portafolio", type: "relation", relationType: "hijo", targetEntity: "Portafolio", graphEntity: "Sys_Graph_Edges", valueField: "id_portafolio", labelField: "nombre", uiComponent: "select_single", label: "Portafolio", isTemporalGraph: true, graphEdgeType: "UNIDAD_NEGOCIO_PORTAFOLIO", topologyCardinality: "1:N", width: 12, workspaceMode: true, dynamicParentField: "id_unidad_negocio", section: "Jerarquía Estratégica" },
      { name: "grupos_productos", type: "relation", relationType: "hijo", targetEntity: "Grupo_Productos", graphEntity: "Sys_Graph_Edges", valueField: "id_grupo_producto", labelField: "nombre", uiComponent: "searchable_multi", label: "Grupo de Producto", isTemporalGraph: true, graphEdgeType: "PORTAFOLIO_GRUPO_PRODUCTO", topologyCardinality: "1:N", width: 12, workspaceMode: true, dynamicParentField: "id_portafolio", section: "Jerarquía Estratégica" }
    ]
  },
  Unidad_Negocio: {
