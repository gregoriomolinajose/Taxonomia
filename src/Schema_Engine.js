...
var APP_SCHEMAS = {
  Taxonomia: {
    ...
    fields: [
      ...
      { name: "head_of_technology", type: "relation", relationType: "hijo", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", valueField: "id_persona", labelField: "_nombre_completo", subtitleField: "id_cargo", subtitleLookup: "Cargo", uiComponent: "searchable_multi", section: "Directorio de TI", label: "Head of Technology", isTemporalGraph: true, graphEdgeType: "TAXONOMIA_HEAD_TECH", topologyCardinality: "N:M", width: 12 },
      { name: "technology_manager", type: "relation", relationType: "hijo", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", valueField: "id_persona", labelField: "_nombre_completo", subtitleField: "id_cargo", subtitleLookup: "Cargo", uiComponent: "searchable_multi", section: "Directorio de TI", label: "Technology Manager", isTemporalGraph: true, graphEdgeType: "TAXONOMIA_TECH_MANAGER", topologyCardinality: "N:M", width: 12 },
      { name: "technical_lead", type: "relation", relationType: "hijo", targetEntity: "Persona", graphEntity: "Sys_Graph_Edges", valueField: "id_persona", labelField: "_nombre_completo", subtitleField: "id_cargo", subtitleLookup: "Cargo", uiComponent: "searchable_multi", section: "Directorio de TI", label: "Technical Lead", isTemporalGraph: true, graphEdgeType: "TAXONOMIA_TECH_LEAD", topologyCardinality: "N:M", width: 12 },
