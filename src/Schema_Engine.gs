...
const APP_SCHEMAS = {
  ...
  Dominio: {
    ...
    fields: [
      ...
      { section: "Topología (Grafo)", width: 6, name: "relaciones_padre", type: "relation", relationType: "padre", targetEntity: "Dominio", graphEntity: "Relacion_Dominios", valueField: "id_dominio", labelField: "n0_es", uiComponent: "select_single", label: "Dominio Padre (1:1)", isTemporalGraph: true, topology: "JERARQUICA_MILITAR" },
      { section: "Topología (Grafo)", width: 6, name: "relaciones_hijo", type: "relation", relationType: "hijo", targetEntity: "Dominio", graphEntity: "Relacion_Dominios", valueField: "id_dominio", labelField: "n0_es", uiComponent: "searchable_multi", label: "Dominios Subordinados (1:N)", isTemporalGraph: true, topology: "JERARQUICA_MILITAR" }
    ]
  },
  Capacidad: {
