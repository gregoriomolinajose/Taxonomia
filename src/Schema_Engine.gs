...
const APP_SCHEMAS = {
  ...
  Dominio: {
    ...
    fields: [
      ...
      { section: "Topología (Grafo)", width: 12, name: "relaciones_padre", type: "relation", relationType: "1:N", targetEntity: "Relacion_Dominios", foreignKey: "id_nodo_hijo", uiBehavior: "subgrid", label: "Administrar Padres (N:M)", isTemporalGraph: true, topology: "JERARQUICA_MILITAR" }
    ]
  },
  Capacidad: {
