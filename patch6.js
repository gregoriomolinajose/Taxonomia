...
let targetFile = 'src/assets/css/data-view.css';
let content = fs.existsSync(targetFile) ? fs.readFileSync(targetFile, 'utf8') : '';

// Remove previous premium css if it was appended locally by mistake
if (content.includes('/* -- PREMIUM GRID CARDS -- */')) {
    content = content.split('/* -- PREMIUM GRID CARDS -- */')[0];
}

fs.writeFileSync(targetFile, content + '\n' + premiumCSS, 'utf8');
console.log('Premium CSS appended to ' + targetFile);
