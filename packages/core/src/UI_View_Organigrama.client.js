...
window.UI_View_Organigrama = {
    ...
    _buildTreeData: function(taxonomyId, perspective) {
        ...
        const rules = {
            producto: [
                { entity: 'Flujo', roleField: 'head_of_product_id', roleTitle: 'Head of Product' },
            ...
            tecnologia: [
                { entity: 'Flujo', roleField: 'head_of_technology_id', roleTitle: 'Head of Technology' },
            ...
            agilidad: [
                { entity: 'Flujo', roleField: 'agile_coach_id', roleTitle: 'Agile Coach' },
            ...
            portafolio: [
                ...
                { entity: 'Flujo', roleField: 'dueno_flujo_id', roleTitle: 'Dueño del Flujo' }
            ]
        };
