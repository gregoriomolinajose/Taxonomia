...
1. **Definición Maestra del Esquema (APP_SCHEMAS):** Definir la nueva entidad en el motor de esquemas. El esquema debe ser un objeto polimórfico (Diccionario de Objetos) y declarar explícitamente el `primaryKey` y `titleField`. Todo nuevo esquema DEBE acatar las siguientes 6 directrices de UI/Datos:
