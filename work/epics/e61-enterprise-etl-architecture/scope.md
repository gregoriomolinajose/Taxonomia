...
|----|-------|:----:|:------:|-------------|
| S61.1 | IDataProvider Interface | S | Pending | Implementar patrón Adapter para abstraer Google Sheets del motor ETL. |
| S61.2 | Metadata Hooks Engine | M | Pending | Mover lógica dura de entidades a APP_SCHEMAS (onRowTransform). |
