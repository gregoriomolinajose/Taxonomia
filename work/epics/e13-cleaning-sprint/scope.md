...
- **[x] S13.3:** Legacy Alias Purging. Purgado del `Router` y sus listeners fantasmas viejos.
- **[x] S13.4:** CSS AST Minifier. Empaquetamiento CSS usando herramientas maduras Node en entorno CI local.
...
| S13.3 | Legacy Alias Purging | Complete | S | S13.1 | Cerrar el E12 routing definitivamente purgando el antiguo Router inactivo. |
| S13.4 | CSS AST Minifier | Complete | M | None | Se puede ejecutar en paralelo; sanea el pipeline Node para alivianar los pases a PROD de CSS gigantescos. |
