...
## Planned Stories
- **S56.1 - Reestructuración del Wizard:** Modificar la configuración del stepper para insertar el Paso 2 (Equipos) y Paso 3 (Personas), desplazando el Canvas al Paso 4.
