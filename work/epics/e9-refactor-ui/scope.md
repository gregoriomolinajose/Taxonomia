...
- [x] Todos los flujos transaccionales (DataView, FormEngine) han sido sanitizados sin `style="..."`.
- [x] La topología Z-Index está documentada y forzada en `CSS_App.html`.
