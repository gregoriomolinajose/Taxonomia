...
| S35.3 | Pruebas Automatizadas UI/Back | Automatización de infraestructura de pruebas para garantizar el EventBus bidireccional, barreras de fuga de RAM (H10) y clausuras UX Mobile del componente SearchableSingle y RelationBuilder | S | — | DONE |
| S35.4 | Refactor: Reglas Topológicas | Centralización de la lógica de filtrado jerárquico y simplificación de patrones de foco detectados en el Architecture Review. | XS | — | DONE |
...
- [x] Retrospectiva y Epica revisada.
